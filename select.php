...
//データ表示SQL作成
$sql = 'SELECT * FROM book_log_table ORDER BY indate DESC';
...
if ($status == false) {
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $view .= '<p>' .'書籍カテゴリ - ' . $result['category'] . '</p>';
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">気になった書籍カテゴリ一覧</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="booksapi.html">googleBooksAPI</a>
                    </li>
                </ul>
            </div>
        </nav>
